...
void push(int a, node **t)
{
    if ((*t) == NULL)
    {
        (*t) = new node;                        // Захват памяти
        (*t)->info = a;                         // Формирование информационной части
        (*t)->l = (*t)->r = NULL;               // Формирование адресных частей
        return;                                 // Возврат созданного указателя
    }
